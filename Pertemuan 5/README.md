...
## Tugas Praktikum 5
**Menerapkan Widget Material Design dan iOS Cupertino<br>**
...
```
3. **Scaffold Widget**
Scaffold widget digunakan untuk mengatur tata letak sesuai dengan material design. <br>Ubah isi kode main.dart seperti berikut.
```dart
import 'package:flutter/material.dart';
